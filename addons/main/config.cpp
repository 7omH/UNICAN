...
class CfgPatches {
	class ADDON {
		name = "UNICAN";
		units[] = {"TOMH_VRSIdent_Small","TOMH_VRSIdent_Big","TOMH_Item_UNICAN","TOMH_Item_UNICAN_Lite","TOMH_Item_UNICAN_Logi","TOMH_Item_Stencil_Medical","TOMH_Item_Stencil_Eod","TOMH_Item_Stencil_Mst0"};
		weapons[] = {};
